          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
            ...
            <div className="flex items-center gap-3 text-sm text-slate-600">
              ...
              <div className="leading-tight">
                ...
                <span className="block text-xs text-slate-500">{t.services.hero.responseUnder24Hours}</span>
              </div>
            </div>
          </div>
    ...
    >
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div className="space-y-2">
          <p className="text-xs uppercase tracking-[0.2em] text-slate-500">{t.services.grid.subtitle}</p>
          <h2 className="font-display text-3xl font-semibold text-[#0f172a]">{t.services.grid.title}</h2>
  ...
  return (
    ...
    >
      <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
        <div className="space-y-2">
          <p className="text-xs uppercase tracking-[0.2em] text-slate-500">{t.services.programs.subtitle}</p>
          <h2 className="font-display text-3xl font-semibold text-[#0f172a]">{t.services.programs.title}</h2>
          <p className="text-base text-slate-600 md:max-w-2xl">
            {t.services.programs.description}
          </p>
        </div>
        <div className="rounded-full bg-[#f3eadc] px-4 py-2 text-sm font-semibold text-[#8b5e2b]">{t.services.programs.noHiddenFees}</div>
      </div>
